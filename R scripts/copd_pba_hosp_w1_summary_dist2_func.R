...
time_stats <- data.frame(
  outcome = "hosp",
  analysis = "summary level_dist2_func",
  sa = output_ext,
...
file_path <- file.path(Graphdir, "QBA", "copd_hosp_w1", paste0("adjusted_RR_SL_pba_dist2", output_ext, ".png"))
...
plot <- ggplot(data = data.frame(x = qba_result$data$or_bb_cb), aes(x = x)) +
  ...
  theme(plot.background = element_rect(fill = "white"),
        ...
        legend.text = element_text(size = 11),
        legend.key.size = unit(1, "cm"))
file_path <- file.path(Graphdir, "QBA", "copd_hosp_w1", paste0("adjusted_OR_SL_pba_dist2", output_ext, ".png"))
ggsave(file_path, plot, width = 8, height = 4)
...
plot <- ggplot(data = data.frame(x = qba_result$data$se), aes(x = x)) +
  ...
  theme(plot.background = element_rect(fill = "white"),
        ...
        axis.title.x = element_text(size = 14),
        axis.title.y = element_text(size = 14))
file_path <- file.path(Graphdir, "QBA", "copd_hosp_w1", paste0("sampled_se_SL_pba_hosp_dist2", output_ext, ".png"))
ggsave(file_path, plot, width = 8, height = 4)
...
plot <- ggplot(data = data.frame(x = qba_result$data$sp), aes(x = x)) +
  ...
  theme(plot.background = element_rect(fill = "white"),
        ...
        axis.title.x = element_text(size = 14),
        axis.title.y = element_text(size = 14))
file_path <- file.path(Graphdir, "QBA", "copd_hosp_w1", paste0("sampled_sp_SL_pba_hosp_dist2", output_ext, ".png"))
ggsave(file_path, plot, width = 8, height = 4)
...
file_path <- file.path(Graphdir, "QBA", "copd_hosp_w1", paste0("sampled_PPV_SL_pba_hosp_dist2", output_ext, ".png"))
ggsave(file_path, plot, width = 8, height = 4)
...
plot <- ggplot(data = qba_result$data, aes(x = NPV_exp, color = "ICS")) +
  ...
  scale_color_manual(values = c("ICS" = palette[9], "LABA/LAMA" = palette[4]), labels = c("ICS", "LABA/LAMA")) +
  guides(color = guide_legend(title = NULL, override.aes = list(fill = c(palette[9], palette[4]))))
file_path <- file.path(Graphdir, "QBA", "copd_hosp_w1", paste0("sampled_NPV_SL_pba_hosp_dist2", output_ext, ".png"))
ggsave(file_path, plot, width = 8, height = 4)
...
plot <- ggplot(data = qba_result$data, aes(x = PrevD_exp, color = "ICS")) +
  ...
  scale_color_manual(values = c("ICS" = palette[9], "LABA/LAMA" = palette[4]), labels = c("ICS", "LABA/LAMA")) +
  guides(color = guide_legend(title = NULL, override.aes = list(fill = c(palette[9], palette[4]))))
file_path <- file.path(Graphdir, "QBA", "copd_hosp_w1", paste0("sampled_Prev_SL_pba_hosp_dist2", output_ext, ".png"))
ggsave(file_path, plot, width = 8, height = 4)
...
conventional_result <- c("SA_cox_log_regression_estimates_all.parquet")
samples <- c("SA_qba_hosp_summary_full_sample_all.parquet")
output_ext <- c("_all")
