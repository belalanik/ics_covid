...
ggsurvplot(km_curve1, data = subset_df, conf.int = T, censor = F, ylim = c(0.95, 1), xlab = "Time in days", risk.table = TRUE, legend.labs = c("LABA/LAMA group", "ICS group"), legend.title = "", palette = c(palette[1], palette[8]))
...
# Plot the Kaplan-Meier curve
ggsurvplot(km_curve2, data = subset_df, conf.int = T, censor = F, ylim = c(0.95, 1), xlab = "Time in days", risk.table = TRUE, legend.labs = c("LABA/LAMA group", "ICS group"), legend.title = "", palette = c(palette[1], palette[4]))
...
# Plot the Kaplan-Meier curve
ggsurvplot(km_curve3, data = subset_df, conf.int = T, censor = F, ylim = c(0.95, 1), xlab = "Time in days", risk.table = TRUE, legend.labs = c("LABA/LAMA group", "ICS group"), legend.title = "", palette = c(palette[1], palette[7]))
