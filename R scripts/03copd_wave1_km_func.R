...
create_plots <- function(inputfile, output_ext) {
...
median_follow_up_hosp <- subset_df %>%
  group_by(treatgroup) %>%
  summarise(median_follow_up_time_hosp = median(timeinstudy2, na.rm = TRUE))
...
file_path <- file.path(Graphdir, "cox_regression", paste0("km_covid_death", output_ext, ".png"))
png(file_path, width = 2000, height = 1500)
print(ggsurvplot)
dev.off()
...
file_path <- file.path(Graphdir, "cox_regression", paste0("km_any_death", output_ext, ".png"))
png(file_path, width = 2000, height = 1500)
print(ggsurvplot)
dev.off()
...
file_path <- file.path(Graphdir, "cox_regression", paste0("cuminc_pos_covid_test", output_ext, ".png"))
...
file_path <- file.path(Graphdir, "cox_regression", paste0("cuminc_covid_hes", output_ext, ".png"))
ggsave(file_path, width = 10, height = 6, dpi = 300)
...
file_path <- file.path(Graphdir, "cox_regression", paste0("cuminc_covid_death", output_ext, ".png"))
ggsave(file_path, width = 10, height = 6, dpi = 300)
...
file_path <- file.path(Graphdir, "cox_regression", paste0("cuminc_any_death", output_ext, ".png"))
ggsave(file_path, width = 10, height = 6, dpi = 300)
...
ggplot(subset_df, aes(x = covid_hes_date)) +
  ...
  theme_minimal()
file_path <- file.path(Graphdir, "cox_regression", paste0("hist_covid_hes_date", output_ext, ".png"))
ggsave(file_path, width = 10, height = 6, dpi = 300)
...
ggplot(subset_df, aes(x = covid_death_date)) +
  ...
  theme_minimal()
file_path <- file.path(Graphdir, "cox_regression", paste0("hist_covid_death_date", output_ext, ".png"))
ggsave(file_path, width = 10, height = 6, dpi = 300)
