...
ps_formula <- treatgroup ~ age_index + gender + eth + imd + bmicat + diabetes_present + hypertension_present + cvd_present + allcancers_present + past_asthma_present + current_asthma_present + kidney_present + immunosuppression_present + flu_vacc_present + pneumo_vacc_present + exacerb_present + smokstatus
