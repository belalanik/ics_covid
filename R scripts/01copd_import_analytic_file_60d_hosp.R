...
#read in csv dataset
df <- read.csv("copd_analytic_file_hosp_w1_60d.csv", colClasses = c("patid" = "character"), header = T)
...
arrow::write_parquet(df, "copd_wave1_60d_hosp.parquet")
...
arrow::write_parquet(df, "copd_wave1_60d_hosp_subset.parquet")
