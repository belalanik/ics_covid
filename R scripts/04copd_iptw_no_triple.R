...
# Date: 03/2023
# Purpose: generate propensity scores and IPTW weights for COPD cohort. Fit Cox models for all three outcomes for cohort with no triple therapy
...
#remove people with baseline_triple
...
file_path <- file.path(Graphdir, "iptw_diagnostics", "SA_ps_model_results_no_triple.xlsx")
...
file_path <- paste0(Tables, "SA_copd_ps_model_death_no_triple.docx")
...
#save as parquet
write_parquet(subset_df, "SA_copd_wave1_60d_iptw_no_triple.parquet")

weight_df <- subset_df %>% dplyr::select(patid, ate_weight_stab, ate_weight_unstab, att_weight_unstab, att_weight_stab)

write_parquet(weight_df, "SA_copd_wave1_60d_iptw_weights_no_triple.parquet")
...
file_path <- file.path(Graphdir, "iptw_diagnostics", "SA_ps_dist_unweighted_no_triple.png")
...
generate_density_plot(subset_df, "ate_weight_unstab", "Distribution of unstabilised ATE Weights by Treatment Group", "SA_dist_ate_unstab_no_triple.png")
generate_density_plot(subset_df, "ate_weight_stab", "Distribution of stabilised ATE Weights Propensity Scores by Treatment Group", "SA_dist_ate_stab_no_triple.png")
generate_density_plot(subset_df, "att_weight_unstab", "Distribution of ATT Weights by Treatment Group", "SA_dist_att_unstab_no_triple.png")
generate_density_plot(subset_df, "att_weight_stab", "Distribution of ATT Weights by Treatment Group", "SA_dist_att_stab_no_triple.png")
...
# Generate density plots
generate_density_plot(subset_df, "ate_weight_unstab", "Distribution of unstabilised ATE-Weighted Propensity Scores by Treatment Group", "SA_ps_dist_ate_unstab_no_triple.png")
generate_density_plot(subset_df, "ate_weight_stab", "Distribution of stabilised ATE-Weighted Propensity Scores by Treatment Group", "SA_ps_dist_ate_stab_no_triple.png")
generate_density_plot(subset_df, "att_weight_unstab", "Distribution of ATT-Weighted Propensity Scores by Treatment Group", "SA_ps_dist_att_unstab_no_triple.png")
generate_density_plot(subset_df, "att_weight_stab", "Distribution of ATT-Weighted Propensity Scores by Treatment Group", "SA_ps_dist_att_stab_no_triple.png")
...
file_path <- file.path(Graphdir,  "iptw_diagnostics", "SA_weights_summary_no_triple.xlsx")
...
#export this to excel
file_path <- file.path(Graphdir,  "iptw_diagnostics", "SA_smd_table_no_triple.xlsx")
...
ggplot(smd_data, aes(x = abs_smd_ate_stab, y = variable)) +
  ...
  labs(title = "Comparison of Absolute SMDs",
       ...
       y = "Variable") +
  scale_y_discrete(labels = c("age_index" = "Age at index", "gender_Female" = "Female gender", "smok_Former smoking" = "Former smoking", "eth_White" = "Ethnicity: White", "eth_South Asian" = "Ethnicity: South Asian", "eth_Mixed" = "Ethnicity: Mixed", "eth_Unknown" = "Ethnicity: Unknown", "bmicat_Underweight (<18.5)" = "BMI: Underweight (< 18.5)", "bmicat_Normal (18.5-24.9)" = "BMI: Normal (18.5-24.9)", "bmicat_Overweight (25-29.9)" = "BMI: Overweight (25-29.9)", "bmicat_Obese (>=30)" = "BMI: Obese (>=30)", "pneumo_vacc_present_Yes" = "Pneumococcal vaccine (past 5 years)", "kidney_present_Yes" = "Chronic kidney disease", "allcancers_present_Yes" = "Cancer", "immunosuppression_present_Yes" = "Immunosuppression", "imd_Missing" = "Missing IMD", "imd_5" = "IMD 5", "imd_4" = "IMD 4", "imd_3" = "IMD 3", "imd_2" = "IMD 2", "imd_1" = "IMD 1", "hypertension_present_Yes" = "Hypertension", "gender_Female" = "Female gender", "flu_vacc_present_Yes" = "Influenza vaccine (past year)", "exacerb_present_Yes" = "COPD exacerbation (past 12 months)", "diabetes_present_Yes" = "Diabetes", "cvd_present_Yes" = "Cardiovascular disease", "bmicat_Normal (18.5-24.9)" = "BMI: Normal (18.5-24.9)", "asthma_present_Yes" = "Past asthma")) + 
  theme_minimal() +
  guides(fill = guide_legend(override.aes = list(color = c(palette[9], palette[6], palette[7])))) +
  labs(fill = NULL, shape = NULL)

file_path <- file.path(Graphdir, "iptw_diagnostics", "SA_SMD_plot_no_triple.png")
...
for (weight_var in weight_vars) {
  ...
  file_path <- file.path(Graphdir, "iptw_diagnostics", paste0("SA_baseline_table_", weight_var, "_no_triple.docx"))
