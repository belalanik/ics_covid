...
generate_density_plot(subset_df, "att_weight_stab", "Distribution of ATT Weights by Treatment Group", "dist_att_stab.png")
...
generate_density_plot(subset_df, "att_weight_stab", "Distribution of stabilised ATT-Weighted Propensity Scores by Treatment Group", "ps_dist_att_stab.png")
