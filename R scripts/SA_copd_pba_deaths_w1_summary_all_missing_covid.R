...
D$covid_death_present <- D$all_missing_covid
...
write_parquet(qba_result$data, file.path(Tables, "QBA", "SA_qba_death_summary_full_sample_all_missing_covid.parquet"))
...
write_parquet(qba_df, file.path(Tables, "QBA", "SA_qba_death_summary_results_all_missing_covid.parquet"))
...
file_path <- file.path(Graphdir, "QBA", "copd_death_w1", "SA_adjusted_RR_SL_all_missing_covid.png")
...
plot <- ggplot(data = data.frame(x = qba_result$data$or_bb_cb), aes(x = x)) +
  ...
  theme(plot.background = element_rect(fill = "white"),
        ...
        legend.text = element_text(size = 11),
        legend.key.size = unit(1, "cm"))
file_path <- file.path(Graphdir, "QBA", "copd_death_w1", "SA_adjusted_OR_SL_all_missing_covid.png")
ggsave(file_path, plot, width = 8, height = 4)
...
plot <- ggplot(data = data.frame(x = qba_result$data$se), aes(x = x)) +
  ...
  theme(plot.background = element_rect(fill = "white"),
        ...
        axis.title.x = element_text(size = 14),
        axis.title.y = element_text(size = 14))
file_path <- file.path(Graphdir, "QBA", "copd_death_w1", "SA_sampled_se_SL_pba_all_missing_covid.png")
ggsave(file_path, plot, width = 8, height = 4)
...
plot <- ggplot(data = data.frame(x = qba_result$data$sp), aes(x = x)) +
  ...
  theme(plot.background = element_rect(fill = "white"),
        ...
        axis.title.x = element_text(size = 14),
        axis.title.y = element_text(size = 14))
file_path <- file.path(Graphdir, "QBA", "copd_death_w1", "SA_sampled_sp_SL_pba_all_missing_covid.png")
ggsave(file_path, plot, width = 8, height = 4)
...
file_path <- file.path(Graphdir, "QBA", "copd_death_w1", "SA_sampled_PPV_SL_pba_death_all_missing_covid.png")
ggsave(file_path, plot, width = 8, height = 4)
...
plot <- ggplot(data = qba_result$data, aes(x = NPV_exp, color = "ICS")) +
  ...
  scale_color_manual(values = c("ICS" = palette[9], "LABA/LAMA" = palette[4]), labels = c("ICS", "LABA/LAMA")) +
  guides(color = guide_legend(title = NULL, override.aes = list(fill = c(palette[9], palette[4]))))
file_path <- file.path(Graphdir, "QBA", "copd_death_w1", "SA_sampled_NPV_SL_pba_death_all_missing_covid.png")
ggsave(file_path, plot, width = 8, height = 4)
...
plot <- ggplot(data = qba_result$data, aes(x = PrevD_exp, color = "ICS")) +
  ...
  scale_color_manual(values = c("ICS" = palette[9], "LABA/LAMA" = palette[4]), labels = c("ICS", "LABA/LAMA")) +
  guides(color = guide_legend(title = NULL, override.aes = list(fill = c(palette[9], palette[4]))))
file_path <- file.path(Graphdir, "QBA", "copd_death_w1", "SA_sampled_Prev_SL_pba_death_all_missing_covid.png")
ggsave(file_path, plot, width = 8, height = 4)
