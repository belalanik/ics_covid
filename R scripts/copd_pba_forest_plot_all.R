...
filepath <- file.path(Tables, "QBA", "qba_death_summary_results_all.parquet")
estimates_death <- read_parquet(filepath)

filepath <- file.path(Tables, "QBA", "qba_hosp_summary_results_all.parquet")
...
#save plot
file_path <- file.path(Graphdir, "QBA", "forest_plot_qba_all.png")
