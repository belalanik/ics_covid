...
hosp_summary <- read_parquet(file.path(Tables, "QBA", hosp_summary_res))
hosp_record <- read_parquet(file.path(Tables, "QBA", hosp_record_res))
death_summary <- read_parquet(file.path(Tables, "QBA", death_summary_res))
death_record <- read_parquet(file.path(Tables, "QBA", death_record_res))
...
#save plot
file_path <- file.path(Graphdir, "QBA", paste0("forest_plot_qba", output_ext, ".png"))
ggsave(filename = file_path, plot = final_forest, width = 18, height = 7, units = "in", dpi = 1000)

}


hosp_summary_res <- c("qba_hosp_summary_results.parquet", "qba_hosp_summary_results_no_triple.parquet", "qba_hosp_summary_results_6m.parquet", "qba_hosp_summary_results_all.parquet")
hosp_record_res <- c("qba_hosp_record_results.parquet", "qba_hosp_record_results_no_triple.parquet", "qba_hosp_record_results_6m.parquet", "qba_hosp_record_results_all.parquet")
death_summary_res <- c("qba_death_summary_results.parquet", "qba_death_summary_results_no_triple.parquet", "qba_death_summary_results_6m.parquet", "qba_death_summary_results_all.parquet")
death_record_res <- c("qba_death_record_results.parquet", "qba_death_record_results_no_triple.parquet", "qba_death_record_results_6m.parquet", "qba_death_record_results_all.parquet")
