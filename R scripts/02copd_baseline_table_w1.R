...
if (file.exists(paste0(Tables, "copd_baseline_w1_60d.docx"))) {
  # Remove the file if it exists
  file.remove(paste0(Tables, "copd_baseline_w1_60d.docx"))
...
if (file.exists(paste0(Tables, "copd_outcomes_w1_60d.docx"))) {
  # Remove the file if it exists
  file.remove(paste0(Tables, "copd_outcomes_w1_60d.docx"))
  cat("File removed successfully.\n")
} else {
  cat("File does not exist.\n")
}
