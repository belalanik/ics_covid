...
D <- read_parquet("SA_copd_wave1_60d_iptw_no_triple.parquet")
...
sensitivities_E1 <- seq(0.5, 1, 0.05)
sensitivities_E0 <- seq(0.5, 1, 0.05)
...
print(plot)
# Save the plot
file_path <- file.path(Graphdir, "QBA", "copd_death_w1", "heatmap_copd_death_differential_no_triple_for_ppt.png")
