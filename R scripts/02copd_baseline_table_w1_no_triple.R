...
if (file.exists(paste0(Tables, "copd_baseline_w1_60d_no_triple.docx"))) {
  # Remove the file if it exists
  file.remove(paste0(Tables, "copd_baseline_w1_60d_no_triple.docx"))
...
if (file.exists(paste0(Tables, "copd_outcomes_w1_60d_no_triple.docx"))) {
  # Remove the file if it exists
  file.remove(paste0(Tables, "copd_outcomes_w1_60d_no_triple.docx"))
  cat("File removed successfully.\n")
} else {
  cat("File does not exist.\n")
}
...
tab2 %>%
  as_flex_table() %>%
  flextable::save_as_docx(path = paste0(Tables, "copd_outcomes_w1_60d_no_triple.docx"), align = "left")
