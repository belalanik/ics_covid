...
df <- read_parquet("copd_wave1_6m.parquet")
...
file_path <- file.path(Graphdir, "iptw_diagnostics", "SA_ps_model_results_6m.xlsx")
...
file_path <- paste0(Tables, "SA_copd_ps_model_death_6m.docx")
...
file_path <- file.path(Graphdir, "iptw_diagnostics", "SA_ps_dist_unweighted_6m.png")
ggsave(file_path, plot, width = 8, height = 4)

# Function to generate density plot of weights
...
file_path <- file.path(Graphdir,  "iptw_diagnostics", "weights_summary_6m.xlsx")
...
file_path <- file.path(Graphdir, "iptw_diagnostics", "SA_SMD_plot_6m.png")
...
for (weight_var in weight_vars) {
  ...
  file_path <- file.path(Graphdir, "iptw_diagnostics", paste0("SA_baseline_table_", weight_var, "_6m.docx"))
