/*=========================================================================
DO FILE NAME:		    09cr_copd_all_drugs.do
...
DESCRIPTION OF FILE:	appends all inhaled medication files, assesses initiations
...
clear all 
capture log close
log using $Logdir/09cr_copd_all_drugs.log , replace
