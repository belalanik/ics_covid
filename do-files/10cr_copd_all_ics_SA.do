/*=========================================================================
DO FILE NAME:		    10cr_copd_all_ics_SA.do
...
DATASETS CREATED:       copd_all_ics_SA.dta //file containing all prescrpitions of ICS containing inhalers
						copd_ics_episodes_initiation_SA
						copd_ics_episodes_6m_SA
						copd_ics_episodes_60d_SA
...
clear all 
capture log close
log using $Logdir/10cr_copd_all_ics_SA.log , replace

cd "$Datadir_copd"

***append datasets containing individual prescriptions
use "$Datadir_copd\\${file_stub}_ics_single_clean_SA.dta"
gen ics_single = 1
...
compress
save "copd_all_ics_SA.dta", replace
export delim "copd_all_ics_SA.csv", replace
...
graph export $Graphdir/initiation_ics_SA.jpg, replace

compress
save "${file_stub}_ics_episodes_initiation_SA", replace
export delim "${file_stub}_ics_episodes_initiation_SA.csv", replace
...
graph export $Graphdir/discontinuation60_ics_SA.jpg, replace

compress
save "${file_stub}_ics_episodes_60d_SA", replace
export delim "${file_stub}_ics_episodes_60d_SA.csv", replace
/************************************************************************
*************************************************************************
...
*************************************************************************/
clear all
use "copd_all_ics_SA.dta", replace
...
graph export $Graphdir/discontinuation6m_ics_SA.jpg, replace

compress
save "${file_stub}_ics_episodes_6m_SA", replace
export delim "${file_stub}_ics_episodes_6m_SA.csv", replace
