/*=========================================================================
DO FILE NAME:			SB_03cr_copd_patient.do
...
cap log close
log using $Logdir\SB_03cr_copd_patient.log, replace
...
*merge in index dates generated in SB_copd_index_date.do
merge m:1 patid using "$Datadir_copd\SB_covid_hes_date_w1.dta", keep(match) nogen

misstable summarize
summarize
compress
save "SB_${file_stub}_Patient", replace 
...
cap drop _merge
merge 1:1 patid using "SB_${file_stub}_Patient"
...
compress
save "SB_${file_stub}_Patient_included.dta", replace
...
compress
save "SB_${file_stub}_Patid_list_included.dta", replace
clear all
...
save "SB_${file_stub}_Patient_included_all.dta", replace
keep patid
save "SB_${file_stub}_Patid_list_included_all.dta", replace
clear all
