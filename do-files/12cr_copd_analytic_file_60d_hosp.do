...
***run globals
capture log close 
log using $Logdir/12cr_copd_analytic_file_60d_hosp.log, replace
...
save "${file_stub}_analytic_file_hosp_w1_no_exposures.dta", replace
...
duplicates drop
export delim "${file_stub}_analytic_file_hosp_w1_60d.csv", replace
