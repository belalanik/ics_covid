/*=========================================================================
DO FILE NAME:		    12cr_copd_analytic_file_60d_all.do
...
DESCRIPTION OF FILE:	Creates analytic file of using "60d after calculated end date" prescription definition, including all people (also people with asthma, other chronic respiratory disease, ltra)

*=========================================================================*/
clear all
***run globals
capture log close 
log using $Logdir/12cr_copd_analytic_file_60d_all.log, replace
...
*** CURRENT ASTHMA
merge 1:1 patid using "${file_stub}_covariate_asthma_current.dta", nogen keep(match master)
...
save "${file_stub}_analytic_file_w1_no_exposures_all.dta", replace
...
duplicates drop
export delim "${file_stub}_analytic_file_w1_60d_all.csv", replace
