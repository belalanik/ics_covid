/*=========================================================================
DO FILE NAME:		    12cr_copd_analytic_file_6m.do
...
DESCRIPTION OF FILE:	Creates analytic file of using "6 months post last prescription" prescription definition

*=========================================================================*/
clear all
***run globals
capture log close 
log using $Logdir/12cr_copd_analytic_file_6m_hosp.log, replace
...
***EXPOSURES
*merge 1:m patid using "${file_stub}_treatment_eps_6m", nogen keep(match master)
...
duplicates drop
export delim "${file_stub}_analytic_file_hosp_w1_6m.csv", replace
